...
import { bookAppointment, cancelAppointment, rescheduleAppointment ,switchDoctorAppointment,getAllAppointmentsByEmail, getAllAppointmentsByEmailOnlyDiagnosis, addOnlineTestTransaction, sendQuetionpdf, onlineTestStatus} from '../controllers/appointmentController.js';
...
appointmentRouter.get("/onlineTestStatus", onlineTestStatus);
